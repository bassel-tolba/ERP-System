...
urlpatterns = [
    ...
    path('landed-cost/<int:pk>/allocate/', ap_views.allocate_landed_cost_invoice_view, name='allocate_landed_cost_invoice'),
    path('financials/landed_cost_invoice/<int:pk>/pay/', ap_views.apply_payment_to_landed_cost_invoice_view, name='apply_payment_to_landed_cost_invoice'),
