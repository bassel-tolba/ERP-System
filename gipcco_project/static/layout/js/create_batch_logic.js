  ...
  if (createBatchForm) {
    ...
    const createMaterialRow = (item, isManualAdd = false) => {
      ...
      row.innerHTML = `
          ...
          <td><input type="number" step="any" class="form-control text-center fw-bold theoretical-qty" name="theoretical_quantity" value="${theoreticalQty.toFixed(3)}" data-base-quantity="${theoreticalQty}" required></td>
          <td><input type="number" step="any" class="form-control text-center fw-bold actual-qty" name="actual_quantity" value="${theoreticalQty.toFixed(3)}" data-base-quantity="${theoreticalQty}" required><div class="invalid-feedback small text-center"></div></td>
